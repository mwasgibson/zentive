    ...
    <footer className="border-t border-border bg-ink text-paper/80">
      <div className="section grid gap-10 py-14 md:grid-cols-3">
        <div>
          <a
            href="#top"
            className="logo font-display text-2xl font-semibold tracking-tight text-paper hover:text-paper/80"
          >
            {siteConfig.productName}
          </a>
          <p className="mt-3 max-w-xs text-sm leading-relaxed text-paper/60">
            A directly-operated bulk SMS platform for the Kenyan market — built
            on a direct SMPP connection to the MNO, not resold through an
            aggregator.
          </p>
        </div>
        <div>
