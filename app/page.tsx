import { Lock, ShieldCheck, KeyRound, ScrollText, Clock3, ListChecks } from "lucide-react";
      ...
      <main id="top">
        ...
        <section className="section pb-20 pt-16 sm:pt-24">
          <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <p className="eyebrow">Bulk SMS, built for Kenyan Enterprises</p>
        ...
        {/* SECURITY & COMPLIANCE */}
        <section id="security" className="border-t border-border bg-ink py-16 text-paper">
          <div className="section">
          ...
          <div className="section">
            ...
            <div className="mt-8 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted">
                  You top up your account, and each successfully delivered message deducts from
                  your balance. Every top-up and deduction is recorded in a transaction ledger you
                  can view and export.
                </p>
              </div>
            </div>
        ...
        <section className="border-t border-border bg-surface py-20">
          <div className="section grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <a href={`mailto:${siteConfig.contactEmail}`} className="btn-secondary mt-8">
                Get API access
              </a>
            </div>
            <div className="card overflow-x-auto bg-ink !p-0">
              ...
              <table className="w-full font-mono text-[12.5px]">
                <tbody>
                  {apiEndpoints.map((e) => (
                    <tr key={e.path} className="border-b border-paper/5 last:border-0">
                      <td className="whitespace-nowrap px-5 py-2.5 text-wire">{e.method}</td>
                      <td className="whitespace-nowrap px-2 py-2.5 text-paper">{e.path}</td>
        ...
        <section id="faq" className="py-20">
          <div className="section grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
                Straight answers, before you talk us.
              </h2>
          ...
          <div className="section flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
            <div>
              ...
              <p className="mt-3 max-w-lg text-muted">
                We&apos;re onboarding a small number of pilot clients ahead of go-live — with recurring, high-volume
                messaging needs. Pilot clients get preferential pricing, direct input into the
                roadmap, and dedicated onboarding support. Tell us about your sending volume and
                use case.
              </p>
            </div>
